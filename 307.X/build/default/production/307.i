...
void lcd_wait(void);
# 166 "./lcd.h"
void lcd_send(_Bool reg, unsigned char data)
{
    TRISB &= 0x0F;
    if (reg) PORTDbits.RD7 = 1, PORTDbits.RD6 = 0; else PORTDbits.RD7 = PORTDbits.RD6 = 0;
    _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = HIGH; _delay((unsigned long)((1)*(20000000/4000000.0))); PORTB = (data & 0xf0) | (PORTB & 0x0f); _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = LOW; _delay((unsigned long)((1)*(20000000/4000000.0)));
    _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = HIGH; _delay((unsigned long)((1)*(20000000/4000000.0))); PORTB = (data << 4) | (PORTB & 0x0f); _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = LOW; _delay((unsigned long)((1)*(20000000/4000000.0)));

    lcd_wait();
}

char lcd_read(_Bool reg)
{
    char data = 0;

    TRISB |= 0xF0;
    if (reg) PORTDbits.RD7 = PORTDbits.RD6 = 1; else PORTDbits.RD7 = 0, PORTDbits.RD6 = 1;
    _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = HIGH; _delay((unsigned long)((1)*(20000000/4000000.0))); data = PORTB & 0xf0; _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = LOW; _delay((unsigned long)((1)*(20000000/4000000.0)));
    _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = HIGH; _delay((unsigned long)((1)*(20000000/4000000.0))); data |= PORTB >> 4; _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = LOW; _delay((unsigned long)((1)*(20000000/4000000.0)));
...
{
    void lcd_entry_mode(_Bool i_d, _Bool s);

    lcd_send(LOW, 0x01);
    lcd_wait();

    lcd_cursor_row = lcd_cursor_col = lcd_shift_pos = 0;
    lcd_entry_mode(entry_mode_i_d, entry_mode_s);
}
...
void lcd_entry_mode(_Bool i_d, _Bool s)
{
    ...
    lcd_send(LOW, 0x04 | ((i_d) ? 1 : 0) << 1 | ((s) ? 1 : 0));
}

void lcd_display_set(_Bool d, _Bool c, _Bool b)
{
    lcd_send(LOW, 0x08 | ((d) ? 1 : 0) << 2 | ((c) ? 1 : 0) << 1 | ((b) ? 1 : 0));
}

void lcd_cur_disp_shift(_Bool s_c, _Bool r_l)
{
    lcd_send(LOW, 0x10 | ((s_c) ? 1 : 0) << 3 | ((r_l) ? 1 : 0) << 2);
}

void lcd_function_set(_Bool dl, _Bool n, _Bool f)
{
    lcd_send(LOW, 0x20 | ((dl) ? 1 : 0) << 4 | ((n) ? 1 : 0) << 3 | ((f) ? 1 : 0) << 2);
    lcd_lines = ((n) ? 1 : 0);
}
...
{
    if (address <= (lcd_lines == 0 ? 0x4f : 0x67) + entry_mode_i_d) {
        lcd_RAM = 0;
        lcd_send(LOW, 0x80 | address);
    } else
        return 0;
...
void lcd_wait(void)
{
    while (lcd_read(LOW) & 0x80) _delay((unsigned long)((1)*(20000000/4000000.0)));
}


void lcd_init(_Bool n, _Bool f)
{
    TRISD &= 0x1f;
    n = ((n) ? 1 : 0);
    f = ((f) ? 1 : 0);
    ...
    TRISB &= 0x0F; PORTDbits.RD7 = PORTDbits.RD6 = 0;
    _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = HIGH; _delay((unsigned long)((1)*(20000000/4000000.0))); PORTB = (0x20) | (PORTB & 0x0f); _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = LOW; _delay((unsigned long)((1)*(20000000/4000000.0)));
    _delay((unsigned long)((40)*(20000000/4000.0)));
    _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = HIGH; _delay((unsigned long)((1)*(20000000/4000000.0))); PORTB = (0x20) | (PORTB & 0x0f); _delay((unsigned long)((1)*(20000000/4000000.0))); PORTDbits.RD5 = LOW; _delay((unsigned long)((1)*(20000000/4000000.0)));
    _delay((unsigned long)((40)*(20000000/4000.0)));

    lcd_function_set(((0) ? 1 : 0), n, f);
    lcd_display_set(LOW, LOW, LOW);
    lcd_clr_disp();
    lcd_entry_mode(HIGH, LOW);
    lcd_display_set(HIGH, HIGH, HIGH);

    _delay((unsigned long)((5)*(20000000/4000.0)));

    left_edge = 0;
    right_edge = lcd_lines ? 0x27 : 0x4f;
}
# 341 "./lcd.h"
void lcd_set_cursor(_Bool row, signed char col)
{
    lcd_set_ddram_adr((((row) ? 1 : 0) ? 0x40 : 0x00) + ((col) < (right_edge + entry_mode_i_d) ? (col) : (right_edge + entry_mode_i_d)));


    lcd_cursor_row = lcd_lines ? ((row) ? 1 : 0) : 0;
    lcd_cursor_col = ((((col) > (left_edge - !entry_mode_i_d) ? (col) : (left_edge - !entry_mode_i_d))) < (right_edge + entry_mode_i_d) ? (((col) > (left_edge - !entry_mode_i_d) ? (col) : (left_edge - !entry_mode_i_d))) : (right_edge + entry_mode_i_d));
...
void lcd_clr_row(unsigned char row)
{
    ...
    lcd_set_ddram_adr(((row) ? 1 : 0) ? 0x40 : 0x00);
...
void lcd_shift_left(signed char n)
{
    ...
    while(n-- && lcd_shift_pos++ < edge) lcd_cur_disp_shift(1, 0);
...
{
    while(n-- && lcd_shift_pos-- > left_edge) lcd_cur_disp_shift(1, 1);
...
void lcd_backspace(signed char n)
{
    ...
    lcd_entry_mode(!entry_mode_i_d, LOW);
...
{
    if (start > end) return;
    start = ((left_edge) > (start) ? (left_edge) : (start)), end = ((end) < (right_edge) ? (end) : (right_edge));

    unsigned char i = ((end - start) > (15) ? (end - start) : (15)) - 15, j, k;
    ...
    while (n--) {
        ...
        for (j = i; j--;) {
            lcd_shift_left(1);
            for (k = speed; k--;) _delay((unsigned long)((50)*(20000000/4000.0)));
        }
        _delay((unsigned long)((500)*(20000000/4000.0)));
        for (j = i; j--;) {
            lcd_shift_right(1);
...
int temperature, temperature1, last_temp = 0;
